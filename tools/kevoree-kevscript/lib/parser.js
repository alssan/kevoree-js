...
var Parser = (function() {
    ...
    parser.prototype = new waxeye.WaxeyeParser(0, true, [new waxeye.FA("kevScript", [new waxeye.State([new waxeye.Edge(1, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
        ...
        new waxeye.FA("add", [new waxeye.State([new waxeye.Edge(17, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false),
                new waxeye.Edge(15, 8, false)], false),
            new waxeye.State([new waxeye.Edge(29, 4, false)], false),
            new waxeye.State([new waxeye.Edge(":", 5, true)], false),
            new waxeye.State([new waxeye.Edge(29, 6, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(29, 11, false)], false),
            new waxeye.State([new waxeye.Edge(26, 7, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("remove", [new waxeye.State([new waxeye.Edge(18, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(15, 3, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("move", [new waxeye.State([new waxeye.Edge(19, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false),
                new waxeye.Edge(15, 6, false),
            ...
            new waxeye.State([new waxeye.Edge("@", 9, true),
                new waxeye.Edge(29, 11, false)], false),
            new waxeye.State([new waxeye.Edge(26, 10, false)], false),
            new waxeye.State([new waxeye.Edge(29, 11, false)], false),
            new waxeye.State([new waxeye.Edge(26, 5, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("attach", [new waxeye.State([new waxeye.Edge(21, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false),
                new waxeye.Edge(15, 6, false),
                new waxeye.Edge("*", 8, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(29, 9, false)], false),
            new waxeye.State([new waxeye.Edge(26, 5, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("detach", [new waxeye.State([new waxeye.Edge(22, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false),
                new waxeye.Edge(15, 6, false),
                new waxeye.Edge("*", 8, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(29, 9, false)], false),
            new waxeye.State([new waxeye.Edge(26, 5, false)], false)], waxeye.FA.LEFT),
        new waxeye.FA("set", [new waxeye.State([new waxeye.Edge(20, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([new waxeye.Edge(29, 4, false)], false),
            new waxeye.State([new waxeye.Edge(9, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("network", [new waxeye.State([new waxeye.Edge(23, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([new waxeye.Edge(29, 4, false)], false),
            new waxeye.State([new waxeye.Edge(27, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("dictionary", [new waxeye.State([new waxeye.Edge(10, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], true),
        ...
        new waxeye.FA("attrList", [new waxeye.State([new waxeye.Edge("{", 1, true)], false),
            ...
            new waxeye.State([new waxeye.Edge([","], 5, true),
                new waxeye.Edge(29, 7, false)], false),
            new waxeye.State([new waxeye.Edge(29, 6, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(26, 10, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("attribute", [new waxeye.State([new waxeye.Edge(26, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            ...
            new waxeye.State([new waxeye.Edge(29, 6, false)], false),
            new waxeye.State([new waxeye.Edge(27, 7, false)], false),
            new waxeye.State([new waxeye.Edge(29, 8, false)], false),
            new waxeye.State([new waxeye.Edge(["\'"], 9, true)], false),
            new waxeye.State([], true),
            new waxeye.State([new waxeye.Edge(29, 11, false)], false),
            new waxeye.State([new waxeye.Edge(27, 12, false)], false),
            new waxeye.State([new waxeye.Edge(29, 13, false)], false),
            new waxeye.State([new waxeye.Edge(["\""], 9, true)], false)], waxeye.FA.LEFT),
        new waxeye.FA("addBinding", [new waxeye.State([new waxeye.Edge(24, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([new waxeye.Edge(".", 4, true)], false),
            new waxeye.State([new waxeye.Edge(26, 5, false)], false),
            new waxeye.State([new waxeye.Edge(29, 6, false)], false),
            new waxeye.State([new waxeye.Edge(15, 7, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("delBinding", [new waxeye.State([new waxeye.Edge(25, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([new waxeye.Edge(".", 4, true)], false),
            new waxeye.State([new waxeye.Edge(26, 5, false)], false),
            new waxeye.State([new waxeye.Edge(29, 6, false)], false),
            new waxeye.State([new waxeye.Edge(15, 7, false),
                new waxeye.Edge("*", 7, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("merge", [new waxeye.State([new waxeye.Edge(16, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge(26, 3, false)], false),
            new waxeye.State([new waxeye.Edge(":", 4, true)], false),
            new waxeye.State([new waxeye.Edge(27, 5, false)], false),
            new waxeye.State([], true)], waxeye.FA.LEFT),
        new waxeye.FA("nameList", [new waxeye.State([new waxeye.Edge(26, 1, false)], false),
            new waxeye.State([new waxeye.Edge(29, 2, false)], false),
            new waxeye.State([new waxeye.Edge([","], 3, true)], true),
            new waxeye.State([new waxeye.Edge(29, 4, false)], false),
        ...
        new waxeye.FA("ws", [new waxeye.State([new waxeye.Edge(["\t", " "], 0, false),
                new waxeye.Edge(28, 0, false)], true)], waxeye.FA.VOID)]);
    return parser;
